...
kubectl get cluster.eks.aws.m.upbound.io -n ${{values.system.split('/')[1]}} -w
kubectl get nodegroup.eks.aws.m.upbound.io -n ${{values.system.split('/')[1]}} -w

# Check for errors
kubectl describe cluster.eks.aws.m.upbound.io <cluster-name> -n ${{values.system.split('/')[1]}}
...
**Check Cluster:**
```bash
kubectl get cluster.eks.aws.m.upbound.io -n ${{values.system.split('/')[1]}} -o wide
kubectl describe cluster.eks.aws.m.upbound.io <cluster-name> -n ${{values.system.split('/')[1]}}
```
...
**Check Nodes:**
```bash
kubectl get nodegroup.eks.aws.m.upbound.io -n ${{values.system.split('/')[1]}} -o wide
kubectl describe nodegroup.eks.aws.m.upbound.io <cluster-name>-nodegroup -n ${{values.system.split('/')[1]}}
```
...
```bash
watch -n 10 'kubectl get cluster.eks.aws.m.upbound.io <cluster-name> -n ${{values.system.split('/')[1]}}'
```
...
**Remove Add-on:**
```bash
kubectl delete addon.eks.aws.m.upbound.io addon-ebs-csi -n ${{values.system.split('/')[1]}}
```
...
**Resource Events:**
```bash
kubectl describe cluster.eks.aws.m.upbound.io <cluster-name> -n ${{values.system.split('/')[1]}} | tail -20
```
...
# Check add-on events
kubectl describe addon.eks.aws.m.upbound.io addon-vpc-cni -n ${{values.system.split('/')[1]}}
```
...
kubectl delete nodegroup.eks.aws.m.upbound.io <cluster-name>-nodegroup \
  -n ${{values.system.split('/')[1]}} --grace-period=0 --force
...
4. **Remove Unused Add-ons**
   ```bash
   kubectl delete addon addon-coredns -n ${{values.system.split('/')[1]}}
   ```
...
```bash
kubectl delete nodegroup.eks.aws.m.upbound.io <cluster-name>-nodegroup -n ${{values.system.split('/')[1]}}
```

**Remove Add-ons Only:**
```bash
kubectl delete addon.eks.aws.m.upbound.io addon-vpc-cni -n ${{values.system.split('/')[1]}}
kubectl delete addon.eks.aws.m.upbound.io addon-coredns -n ${{values.system.split('/')[1]}}
kubectl delete addon.eks.aws.m.upbound.io addon-kube-proxy -n ${{values.system.split('/')[1]}}
kubectl delete addon.eks.aws.m.upbound.io addon-pod-identity -n ${{values.system.split('/')[1]}}
```
...
```bash
# Delete from kubectl
kubectl delete cluster.eks.aws.m.upbound.io <cluster-name> -n ${{values.system.split('/')[1]}}
...
```bash
# List resources
kubectl get eks.aws.m.upbound.io -n ${{values.system.split('/')[1]}}
kubectl get ec2.aws.m.upbound.io -n ${{values.system.split('/')[1]}}
kubectl get iam.aws.m.upbound.io -n ${{values.system.split('/')[1]}}

# Delete with finalizers
kubectl patch cluster.eks.aws.m.upbound.io <cluster-name> -n ${{values.system.split('/')[1]}} \
